...
var _eeue56$elm_html_in_elm$ElmHtml_Constants$attributeNamespaceKey = 'ATTR_NS';
var _eeue56$elm_html_in_elm$ElmHtml_Constants$attributeKey = 'ATTR';
var _eeue56$elm_html_in_elm$ElmHtml_Constants$eventKey = 'EVENT';
var _eeue56$elm_html_in_elm$ElmHtml_Constants$styleKey = 'STYLE';
var _eeue56$elm_html_in_elm$ElmHtml_Constants$knownKeys = {
	ctor: '::',
	_0: _eeue56$elm_html_in_elm$ElmHtml_Constants$styleKey,
	_1: {
		ctor: '::',
		_0: _eeue56$elm_html_in_elm$ElmHtml_Constants$eventKey,
		_1: {
			ctor: '::',
			_0: _eeue56$elm_html_in_elm$ElmHtml_Constants$attributeKey,
			_1: {
				ctor: '::',
				_0: _eeue56$elm_html_in_elm$ElmHtml_Constants$attributeNamespaceKey,
				_1: {ctor: '[]'}
			}
		}
	}
...
var _eeue56$elm_html_in_elm$ElmHtml_Helpers$filterKnownKeys = _elm_lang$core$Dict$filter(
	F2(
		function (key, _p0) {
			return !A2(_elm_lang$core$List$member, key, _eeue56$elm_html_in_elm$ElmHtml_Constants$knownKeys);
		}));
...
var _user$project$TZ_Route$resume = 'resume';
var _user$project$TZ_Route$stacks = 'stacks';
var _user$project$TZ_Route$blog = 'blog';
var _user$project$TZ_Route$routeToPath = function (route) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'/',
		function () {
			...
			switch (_p0.ctor) {
				case 'NotFound':
					return '';
				case 'Blog':
					return _user$project$TZ_Route$blog;
				case 'Work':
					return _user$project$TZ_Route$resume;
				default:
					return _user$project$TZ_Route$stacks;
			}
		}());
};
var _user$project$TZ_Route$change = function (_p1) {
	return _elm_lang$navigation$Navigation$newUrl(
		_user$project$TZ_Route$routeToPath(_p1));
};
var _user$project$TZ_Route$Stacks = {ctor: 'Stacks'};
var _user$project$TZ_Route$Work = {ctor: 'Work'};
var _user$project$TZ_Route$Blog = {ctor: 'Blog'};
var _user$project$TZ_Route$initial = _user$project$TZ_Route$Blog;
var _user$project$TZ_Route$pathParser = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _user$project$TZ_Route$initial, _evancz$url_parser$UrlParser$top),
		_1: {
			ctor: '::',
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_user$project$TZ_Route$Blog,
				_evancz$url_parser$UrlParser$s(_user$project$TZ_Route$blog)),
			_1: {
				ctor: '::',
				_0: A2(
					_evancz$url_parser$UrlParser$map,
					_user$project$TZ_Route$Work,
					_evancz$url_parser$UrlParser$s(_user$project$TZ_Route$resume)),
				_1: {
					ctor: '::',
					_0: A2(
						_evancz$url_parser$UrlParser$map,
						_user$project$TZ_Route$Stacks,
						_evancz$url_parser$UrlParser$s(_user$project$TZ_Route$stacks)),
					_1: {ctor: '[]'}
				}
			}
		}
	});
var _user$project$TZ_Route$NotFound = {ctor: 'NotFound'};
var _user$project$TZ_Route$fromLocation = function (location) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		_user$project$TZ_Route$NotFound,
		A2(_evancz$url_parser$UrlParser$parsePath, _user$project$TZ_Route$pathParser, location));
};

var _user$project$TZ_Model$Model = function (a) {
	return {route: a};
};
var _user$project$TZ_Model$ChangeRoute = function (a) {
	return {ctor: 'ChangeRoute', _0: a};
};
var _user$project$TZ_Model$LocationChanged = function (a) {
	return {ctor: 'LocationChanged', _0: a};
};
var _user$project$TZ_Model$NoOp = {ctor: 'NoOp'};

var _user$project$TZ_Style$None = {ctor: 'None'};
var _user$project$TZ_Style$stylesheet = _mdgriffith$style_elements$Style$styleSheet(
	{
		ctor: '::',
		_0: A2(
			_mdgriffith$style_elements$Style$style,
			_user$project$TZ_Style$None,
			{ctor: '[]'}),
		_1: {ctor: '[]'}
	});

var _user$project$TZ_Page_Blog$view = A3(
	_mdgriffith$style_elements$Element$column,
	_user$project$TZ_Style$None,
	{ctor: '[]'},
	{
		ctor: '::',
		_0: _mdgriffith$style_elements$Element$text('Blog'),
		_1: {ctor: '[]'}
	});
var _user$project$TZ_Page_Blog$update = F2(
	function (msg, model) {
		var _p0 = msg;
		return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
	});
var _user$project$TZ_Page_Blog$init = {};
var _user$project$TZ_Page_Blog$Model = {};
var _user$project$TZ_Page_Blog$NoOp = {ctor: 'NoOp'};

var _user$project$TZ_Page_Stacks$view = A3(
	_mdgriffith$style_elements$Element$column,
	_user$project$TZ_Style$None,
	{ctor: '[]'},
	{
		ctor: '::',
		_0: _mdgriffith$style_elements$Element$text('Stacks'),
		_1: {ctor: '[]'}
	});
var _user$project$TZ_Page_Stacks$update = F2(
	function (msg, model) {
		var _p0 = msg;
		return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
	});
var _user$project$TZ_Page_Stacks$init = {};
var _user$project$TZ_Page_Stacks$Model = {};
var _user$project$TZ_Page_Stacks$NoOp = {ctor: 'NoOp'};

var _user$project$TZ_Page_Work$view = A3(
	_mdgriffith$style_elements$Element$column,
	_user$project$TZ_Style$None,
	{ctor: '[]'},
	{
		ctor: '::',
		_0: _mdgriffith$style_elements$Element$text('R'),
		_1: {ctor: '[]'}
	});
var _user$project$TZ_Page_Work$update = F2(
	function (msg, model) {
		var _p0 = msg;
		return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
	});
var _user$project$TZ_Page_Work$init = {};
var _user$project$TZ_Page_Work$Model = {};
var _user$project$TZ_Page_Work$NoOp = {ctor: 'NoOp'};

var _user$project$TZ_View$navigation = A3(
	...
	{ctor: '[]'},
	{
		...
		_0: A3(
			...
			_user$project$TZ_Style$None,
			{ctor: '[]'},
			_mdgriffith$style_elements$Element$text('TZ')),
		_1: {
			ctor: '::',
			_0: A3(
				_mdgriffith$style_elements$Element$row,
					...
					_0: A3(
						...
						_user$project$TZ_Style$None,
						{
							...
							_0: _mdgriffith$style_elements$Element_Events$onClick(
								_user$project$TZ_Model$ChangeRoute(_user$project$TZ_Route$Blog)),
							_1: {ctor: '[]'}
						},
					...
					_1: {
						...
						_0: A3(
							...
							_user$project$TZ_Style$None,
							{
								ctor: '::',
								_0: _mdgriffith$style_elements$Element_Events$onClick(
									_user$project$TZ_Model$ChangeRoute(_user$project$TZ_Route$Work)),
								_1: {ctor: '[]'}
							},
							_mdgriffith$style_elements$Element$text('R')),
						_1: {
							ctor: '::',
							_0: A3(
								_mdgriffith$style_elements$Element$el,
								_user$project$TZ_Style$None,
								{
									ctor: '::',
									_0: _mdgriffith$style_elements$Element_Events$onClick(
										_user$project$TZ_Model$ChangeRoute(_user$project$TZ_Route$Stacks)),
									_1: {ctor: '[]'}
								},
								_mdgriffith$style_elements$Element$text('Stacks')),
							_1: {ctor: '[]'}
						}
					}
				}),
...
var _user$project$TZ_View$view = function (model) {
	return A2(
		_mdgriffith$style_elements$Element$viewport,
		_user$project$TZ_Style$stylesheet,
		A3(
			_mdgriffith$style_elements$Element$column,
			_user$project$TZ_Style$None,
			{ctor: '[]'},
			{
				ctor: '::',
				_0: _user$project$TZ_View$navigation,
				_1: {
					ctor: '::',
					_0: _mdgriffith$style_elements$Element$text('view'),
					_1: {
						ctor: '::',
						_0: function () {
							var _p0 = model.route;
							switch (_p0.ctor) {
								case 'Blog':
									return _user$project$TZ_Page_Blog$view;
								case 'Work':
									return _user$project$TZ_Page_Work$view;
								case 'Stacks':
									return _user$project$TZ_Page_Stacks$view;
								default:
									return _mdgriffith$style_elements$Element$empty;
							}
						}(),
...
var _user$project$TZ_StaticView$viewStacks = _user$project$TZ_View$view(
	{route: _user$project$TZ_Route$Stacks});
var _user$project$TZ_StaticView$viewWork = _user$project$TZ_View$view(
	{route: _user$project$TZ_Route$Work});
var _user$project$TZ_StaticView$viewBlog = _user$project$TZ_View$view(
	{route: _user$project$TZ_Route$Blog});
		...
		init: {
			...
			_1: _user$project$PrivateMain$htmlOut(
				A2(
					...
					{
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: 'work.html', _1: _user$project$TZ_StaticView$viewWork},
						_1: {ctor: '[]'}
					}))
		},
		update: F2(
...
var Elm = {};
Elm['PrivateMain'] = Elm['PrivateMain'] || {};
if (typeof _user$project$PrivateMain$main !== 'undefined') {
    _user$project$PrivateMain$main(Elm['PrivateMain'], 'PrivateMain', undefined);
}
